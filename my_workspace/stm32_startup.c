...
/* function prototypes of STM32F446x system exception and IRQ handlers */
...
void FMPI2C1ERROR_IRQHandler        (void) __attribute__ ((weak, alias("Default_Handler")));
...
uint32_t vectors[] __attribute__ ((section(".isr_vector"))) = {
	...
	(uint32_t)&HDMICEC_IRQHandler,
	(uint32_t)&SPDIFRX_IRQHandler,
	(uint32_t)&FMPI2C1_IRQHandler,
	(uint32_t)&FMPI2C1ERROR_IRQHandler
